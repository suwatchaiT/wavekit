...
export default function Home() {
  ...
  return <main>
    ...
    <footer><div className="brand inverse"><span className="brand-mark">W</span><span>Wave<span>Kit</span><small>RF ENGINEERING TOOLS · BETA 0.1</small></span></div><p>Reference-only planning tools. Validate every result against current standards, vendor data and local requirements.</p><div><Link href="/info/about">About</Link><Link href="/info/methodology">Methodology</Link><Link href="/info/readiness">Readiness</Link><Link href="/info/privacy">Privacy</Link><Link href="/info/disclaimer">Disclaimer</Link><a href="#top">Back to top ↑</a></div></footer>
  </main>;
}
